...
export default function SongfessSlideshow() {
    ...
    return (
        <section className="pb-28 bg-primaryBG">
                ...
                {songfessData.length > 0 ? (
                    songfessData.map((songfess, index) => (
                        <Link key={`${songfess.id}-${index}`} href={`/himtalks/songfess/${songfess.id}`} passHref>
                            <motion.div
                                key={index}
                                className="w-70 md:w-100 shrink-0 bg-white rounded-2xl shadow-lg"
                    ...
                    >
                        <div className="px-5 pt-5 pb-1">
                            ...
                            <div className="h-17.5 md:h-20 flex items-center md:mt-2">
                                <p className="font-semibold text-base text-darkSage md:text-lg font-cormorant line-clamp-2 overflow-hidden text-ellipsis">Tidak ada songfess yang terkirim</p>  
                            </div>
                        </div>
